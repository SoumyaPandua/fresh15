...
const auditSchema = new mongoose.Schema(
  {
    ...
    outcome: { type: String, enum: ["SUCCESS", "FAILURE", "UNKNOWN"], default: "UNKNOWN", index: true },
    severity: { type: String, enum: ["INFO", "NOTICE", "WARNING", "HIGH", "CRITICAL"], default: "INFO", index: true },
    source: { type: String, default: "api", index: true },
    geo: {
