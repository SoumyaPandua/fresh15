...
import { assignRiderValidation, createDeliveryValidation, updateDeliveryStatusValidation, verifyDeliveryOtpValidation, uploadDeliveryProofValidation, failDeliveryValidation } from "./delivery.validation.js";
import partnerReadinessMiddleware from "./partner-readiness.middleware.js";
import { assignRider, collectCodPayment, createDelivery, deleteDelivery, getAllDeliveries, getAvailableRiders, getDeliveryById, getMyActiveDelivery, getMyDeliveries, updateDeliveryStatus, getCustomerDeliveryByOrder, getDeliveryRoute, getCustomerDeliveryOtp, verifyDeliveryOtp, customerConfirmDelivery, uploadDeliveryProof, failDelivery } from "./delivery.controller.js";
...
router.patch("/:id/status", authorize("ADMIN", "SUPER_ADMIN", "PARTNER"), updateDeliveryStatusValidation, validateRequest, partnerReadinessMiddleware, updateDeliveryStatus);
